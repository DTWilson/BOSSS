...
df <- rbind(df, data.frame(m = c(16, 21, 33,
                                 25, 32, 18, 22, 19, 28, 17, 36, 15, 20, 39),
                           N = c(16*31, 21*18, 33*9,
                                 25*12, 32*8, 18*24, 22*15, 19*20, 28*10, 17*26, 36*7, 15*31, 20*18, 39*6),
                           t = c(rep("Initial", 3), rep("Final", 11))))
