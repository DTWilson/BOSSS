...
prob <- BOSSS_problem(sim_trial, design_space, hypotheses, constraints, objectives, det_func = det_func)
...
problem <- BOSSS_problem(sim_bayes, design_space, hypotheses, constraints, objectives, det_func = det_bayes)
